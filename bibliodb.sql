...
CREATE TABLE `collocati` (
  ...
  `bloccato_fino` int DEFAULT NULL,
...
INSERT INTO `collocati` VALUES ('ROM.01',1,1,1,NULL),('ROM.02',1,1,2,NULL),(NULL,0,1,10,NULL),(NULL,0,1,11,NULL),('ROM.03',1,1,12,NULL),(NULL,0,1,14,NULL),(NULL,0,1,16,NULL),('ROM.04',1,1,23,NULL),('ROM.05',1,1,24,NULL),('ROM.06',1,1,39,NULL),('ROM.07',1,1,40,NULL),('ROM.08',1,1,41,NULL),('ROM.09',1,1,45,NULL),('ROM.10',1,1,46,NULL),('ROM.11',1,1,47,NULL),('ROM.12',1,1,81,NULL),('ROM.13',1,1,82,NULL),('ROM.14',1,1,83,NULL),('FIL.01',1,2,3,NULL),('DIS.01',1,3,4,NULL),('DIS.02',1,3,5,NULL),('DIS.03',1,3,25,NULL),(NULL,0,3,27,NULL),('DIS.05',1,3,28,NULL),('DIS.06',1,3,29,NULL),('SAT.01',1,4,6,NULL),('FAN.01',1,5,7,NULL),('FAN.02',1,5,8,NULL),('FAN.03',1,5,17,NULL),('FAN.04',1,5,18,NULL),('FAN.05',1,5,19,NULL),('FAN.06',1,5,26,NULL),('FAN.07',1,5,87,NULL),('NAR.01',1,6,9,NULL),('NAR.02',1,6,36,NULL),('NAR.03',1,6,37,NULL),('NAR.04',1,6,38,NULL),('NAR.05',1,6,42,NULL),('NAR.06',1,6,43,NULL),('NAR.07',1,6,44,NULL),('NAR.08',1,6,54,NULL),('NAR.09',1,6,55,NULL),('NAR.10',1,6,56,NULL),('NAR.11',1,6,57,NULL),('NAR.12',1,6,58,NULL),('NAR.13',1,6,59,NULL),('NAR.14',1,6,63,NULL),('NAR.15',1,6,64,NULL),('NAR.16',1,6,65,NULL),('NAR.17',1,6,72,NULL),('NAR.18',1,6,73,NULL),('NAR.19',1,6,74,NULL),('NAR.20',1,6,75,NULL),('NAR.21',1,6,76,NULL),('NAR.22',1,6,77,NULL),('NAR.23',1,6,84,NULL),('NAR.24',1,6,85,NULL),('NAR.25',1,6,86,NULL),('REA.01',1,7,13,NULL),(NULL,0,8,15,NULL),('GIA.01',1,10,20,NULL),('GIA.02',1,10,21,NULL),('STO.01',1,11,22,NULL),('AUT.01',1,12,30,NULL),('AUT.02',1,12,31,NULL),('AUT.03',1,12,32,NULL),('RAC.01',1,13,33,NULL),('RAC.02',1,13,34,NULL),('RAC.03',1,13,35,NULL),('RAC.04',1,13,48,NULL),('RAC.05',1,13,49,NULL),('RAC.06',1,13,50,NULL),('FAS.01',1,14,51,NULL),('FAS.02',1,14,52,NULL),('FAS.03',1,14,53,NULL),('ROA.01',1,15,60,NULL),('ROA.02',1,15,61,NULL),('ROA.03',1,15,62,NULL),('ROA.04',1,15,69,NULL),('ROA.05',1,15,70,NULL),('ROA.06',1,15,71,NULL),('POE.01',1,16,66,NULL),('POE.02',1,16,67,NULL),('POE.03',1,16,68,NULL),('NAC.01',1,17,78,NULL),('NAC.02',1,17,79,NULL),('NAC.03',1,17,80,NULL);
...
CREATE TABLE `operatori` (
  ...
  CONSTRAINT `operatori_ibfk_1` FOREIGN KEY (`id_settore`) REFERENCES `settori` (`id_settore`)
...
INSERT INTO `operatori` VALUES (1,'Federico D\'Angelo','federicodangelo','280822',3);
...
INSERT INTO `prestiti_libri` VALUES (3,3),(1,5),(5,6),(4,7),(3,8),(2,9),(9,10),(9,11),(1,12),(5,13),(8,14),(7,15),(10,16),(6,18),(3,21),(6,22),(12,27);
...
CREATE TABLE `ritardi` (
  `id_ritardi` int NOT NULL AUTO_INCREMENT,
...
/*!50001 VIEW `libri_disponibili` AS select `l`.`codice_libro` AS `codice_libro`,`l`.`nome` AS `titolo`,`l`.`edizione` AS `edizione`,`l`.`anno` AS `anno`,`l`.`costo_prestito` AS `costo_prestito`,`l`.`genere` AS `genere`,`a`.`nome` AS `autore`,`c`.`posizione` AS `posizione`,`c`.`settori_id_settore` AS `settori_id_settore`,`l`.`copertina` AS `copertina`,`c`.`disponibilita` AS `disponibilita` from ((`libri` `l` join `autori` `a` on((`l`.`autori_id_autori` = `a`.`id_autori`))) join `collocati` `c` on((`l`.`codice_libro` = `c`.`libri_codice_libro`))) */;
...
-- Dump completed on 2025-07-30 11:16:15
